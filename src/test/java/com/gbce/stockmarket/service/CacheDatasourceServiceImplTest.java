...
public class CacheDatasourceServiceImplTest {
    ...
    private void storeMultipleTrades(Stock stock1, Stock stock2) {
        ...
        Trade trade1 = new Trade(stock1, Direction.BUY, new BigDecimal(20), 12);
    ...
    public void storeMultipleTradesWithValidInputs() {
        Stock stock1 = new CommonStock("TEA", 100, 20);
        Stock stock2 = new CommonStock("POP", 10, 200);
    ...
    public void throwIllegalArgumentExceptionWhileStoringTradeWhenTradeIsInvalid() {
    ...
    public void storeMultipleStockWhenStockIsValid() {
        Stock stock1 = new CommonStock("TEA", 100, 20);
        Stock stock2 = new CommonStock("POP", 101, 20);
        Stock stock3 = new CommonStock("ABC", 10, 35);
    ...
    private void storeStocks() {
        Stock stock1 = new CommonStock("TEA", 100, 20);
        Stock stock2 = new CommonStock("POP", 10, 28);
        Stock stock3 = new CommonStock("JPM", 10, 12);
        Stock stock4 = new CommonStock("ABC", 15, 20);
        Stock stock5 = new CommonStock("GINI", 1, 2);
