...
public class CacheDatasourceServiceImpl implements DatasourceService {
    ...
    public void storeTrade(Trade trade) {
        if (trade == null) {
            throw new IllegalArgumentException("Invalid Trade provided, trade=" + null);
        }
    ...
    public void storeStock(Stock stock) {
        if (stock == null) {
            throw new IllegalArgumentException("Provided stock is not valid stock=" + null);
        }
    ...
    public Stock getStock(String stockSymbol) {
        if (stockSymbol == null || stockSymbol.isEmpty()) {
            throw new IllegalArgumentException("Provided stock symbol is not valid stockSymbol=" + stockSymbol);
        }
